...
//Diccionario de equivalencia de nombre de campo de operadores básicos a código
export const MATH_H_MACROS_CODE_DICT: {[key:string]: string} = {
...
//Diccionario de equivalencia de nombre de campo de macros de la librería stdio.h a código
export const STDIO_H_MACROS_NAME_CODE_DICT: {[key:string]: string} = {
    "NULL": "NULL",
    "FILE": "FILE",
    "FPOST": "fpos_t",
    "IOFBF": "_IOFBF",
...
//Diccionario de equivalencia de nombre de campo de funciones de la librería stdio.h a código
export const STDIO_H_FUNCTIONS_NAME_CODE_DICT: {[key:string]: string} = {
    "FCLOSE": "fclose",
    "CLEARERR": "clearerr",
    "FEOF": "feof",
    "FERROR": "ferror",
...
//Diccionario de equivalencia de nombre de campo de macros de la librería stdlib.h a código
export const STDLIB_H_CONSTANTS_NAME_CODE_DICT: {[key:string]: string} = {
...
//Diccionario de equivalencia de nombre de campo de funciones de la librería stdlib.h a código
export const STDLIB_H_FUNCTIONS_NAME_CODE_DICT: {[key:string]: string} = {
    "_EXIT": "_Exit",
    "A64L": "a64l",
    "ABORT": "abort",
    "ABS": "abs",
